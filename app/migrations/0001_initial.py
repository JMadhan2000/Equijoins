# Generated by Django 4.2.6 on 2024-01-30 11:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='salgrade',
            fields=[
                ('garade', models.IntegerField(primary_key=True, serialize=False)),
                ('lowgrade', models.DecimalField(decimal_places=2, max_digits=10)),
                ('higrade', models.DecimalField(decimal_places=2, max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='emp',
